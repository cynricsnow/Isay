 ...
 */
public class NewIsayGridImgsAdapter extends BaseAdapter{
    private Context mContext;
    private List<Uri> mUriList;
    private GridView mGridView;

    public NewIsayGridImgsAdapter(Context context, List<Uri> uriList, GridView gridView) {
        mContext    =   context;
        mUriList    =   uriList;
        mGridView   =   gridView;
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = View.inflate(mContext, R.layout.item_new_grid_image, null);
